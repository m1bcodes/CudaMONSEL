...
The method \texit{randomScatteringAngle} returns a randomized scattering angle in the range [0,PI] that comes from the distribution of scattering angles for an electron of specified energy on an atom of the element represented by the instance of the class.
...
Screened Rutherford cross section is applicable to high energy (\>20keV) electrons. 
\begin{align*}
