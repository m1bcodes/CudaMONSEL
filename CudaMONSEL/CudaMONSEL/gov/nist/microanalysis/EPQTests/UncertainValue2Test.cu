...
namespace UncertainValue2Test
{
   __device__ UncertainValue2::UncertainValue2 makeA2a()
   {
      ...
      res.assignComponent("V1", sqrtf(0.05));
      res.assignComponent("V2", sqrtf(0.04));
      return res;
   }
   ...
   __device__ UncertainValue2::UncertainValue2 makeB2a()
   {
      ...
      res.assignComponent("V1", sqrtf(0.84));
      res.assignComponent("V2", sqrtf(0.6));
      return res;
   }
   ...
   __device__ UncertainValue2::UncertainValue2 makeC2a()
   {
      ...
      res.assignComponent("V1", sqrtf(3.0));
      res.assignComponent("V3", sqrtf(1.41));
      return res;
   }
   ...
   {
      bool b = false;
      b = fabsf(uv.doubleValue() - uv2.doubleValue()) < delta;
      if (!b) {
         printf("values are different: %lf, %lf", uv.doubleValue(), uv2.doubleValue());
      }
      b = fabsf(uv.uncertainty() - uv2.uncertainty()) < delta;
      if (!b) {
         printf("sigmas are different: %lf, %lf", uv.uncertainty(), uv2.uncertainty());
      }
   }
   ...
   //   UncertainValue2 a = new UncertainValue2(1.0, "A", 0.1);
   //   UncertainValue2 b = new UncertainValue2(2.0, "A", 0.2);
   ...
   //   // Example page 22 GUM
   //   UncertainValue2[] rsc = new UncertainValue2[] {
   ...
   //   UncertainValue2 a = new UncertainValue2(1.0, "A", 0.1);
   //   UncertainValue2 b = new UncertainValue2(2.0, "B", 0.2);
   ...
   //   // Example page 22 GUM
   //   UncertainValue2[] rsu = new UncertainValue2[] {
   ...
   //   UncertainValue2 a = new UncertainValue2(1.0, "A", 0.1);
   //   UncertainValue2 b = new UncertainValue2(2.0, "B", 0.2);
   //   UncertainValue2 c = new UncertainValue2(3.0, "A", 0.15);
   ...
   //   UncertainValue2 a = new UncertainValue2(1.1, "A", 0.1);
   //   UncertainValue2 b = new UncertainValue2(2.3, "B", 0.2);
   //   UncertainValue2 c = new UncertainValue2(3.6, "A", 0.15);
   ...
   //   assertEquals(UncertainValue2.divide(a, c), new UncertainValue2(0.3055555556, (0.1 / 1.1 + 0.15 / 3.6) * 0.3055555556), 1.0e-6);
