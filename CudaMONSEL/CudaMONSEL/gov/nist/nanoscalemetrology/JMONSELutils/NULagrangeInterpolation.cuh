...
namespace NULagrangeInterpolation
{
   ...
   extern __host__ __device__ VectorXd d1(const float fsamp[], int fsamplen, const double xsamp[], int xsamplen, int order, double x);
   extern __host__ __device__ VectorXd d2(const MatrixXf& f, const MatrixXd& xsamp, int order, const double x[], int xlen);
   extern __host__ __device__ VectorXd d3(const Matrix3DXf& f, const MatrixXd& xsamp, int order, const double x[], int xlen);
}
