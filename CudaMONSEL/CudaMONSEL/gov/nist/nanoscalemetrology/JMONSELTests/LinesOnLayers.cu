...
//
//      MONSEL_MaterialScatterModelT PMMAMSM(&PMMA, nullptr);
...
//
//      MONSEL_MaterialScatterModelT PMMAMSMDeep(&PMMA, nullptr);
...
//
//      MONSEL_MaterialScatterModelT glCMSM(&glC, nullptr);
//      glCMSM.addScatterMechanism(&glCNISTMott);
//      glCMSM.addScatterMechanism(&glCDS);
//
//      MONSEL_MaterialScatterModelT glCMSMDeep(&glC, nullptr);
...
//      double binSizeEV = 10.;
//
//      MonteCarloSS::MonteCarloSS monte();
//
...
//
//         BackscatterStats back = new BackscatterStats(monte);
...
//
//            Histogram hist = back.backscatterEnergyHistogram();
//
